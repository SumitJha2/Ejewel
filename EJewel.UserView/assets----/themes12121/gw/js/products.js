    ...
    $(document).ready(function () {
        ...
        var onHoverIntent = function () {
            ...
            if (self.hasClass('product-small')) {
                self.find('.hover-background').animate({ left: '45px' }, 250);//55
            }
            else {
                self.find('.hover-background').animate({ left: '80px' }, 250);//100
            }
        };
        ...
        var outHoverIntent = function () {
           ...
           // self.find('.product-info').css('background', 'rgba(0, 0, 0, 0.5)'); //NEW EDIT
