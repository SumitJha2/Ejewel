...
//            $(this).children(".child-nav").stop(true, true).slideDown(1000);//300
//            $(this).children(':first').css('color', '#8B0000');
//        },
//		function () {
//		    $(this).children(".child-nav").stop(true, true).slideUp(1000, function () {
