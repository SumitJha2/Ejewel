...
<ul id="mainNav">			
            ...
            <li  class="nav">
				<a href="javascript:;">Stone Inventory</a>
				<ul class="subNav">
			...
			<li  class="nav">
				...
				<ul class="subNav">
                    ...
                    <li><a href="/Master/Setting/ListProductFilter.aspx">Product Filter</a></li>
                    <li><a href="/Common/Sfm/SfmList.aspx?view=attribute_heading">Attribute Title</a></li>
                    <li><a href="/Master/Setting/ListProductAttribute.aspx">Product Attribute</a></li>
				</ul>						
			</li>
             <!--Chain-->	
			<li  class="nav">
				...
				<ul class="subNav">
					...
					<li><a href="/Common/Sfm/SfmList.aspx?view=chain_length">Chain Length</a></li>
                       <li><a href="/Common/Sfm/SfmList.aspx?view=chain_clasp">Chain Clasp</a></li>
				</ul>						
			</li>
            <!--Certificate-->	
			<li  class="nav">
            ...
            <!--Stone-->	
			<li  class="nav">
				<a href="javascript:;">Stone Master</a>
				<ul class="subNav">
            ...
            <li  class="nav">
             ...
             <li  class="nav">
				...
				<ul class="subNav">
                     ...
                     <li><a href="/Customers/QueriesOnProduct.aspx">Products (Queries)</a></li>
                         <li><a href="/Customers/ProductReviewStatus.aspx">Product Review Status (Active to be viewed in frontend)</a></li>
                          <li><a href="/Customers/CustomerDesignRing.aspx">Custom Design Ring</a></li>
                          <li><a href="/Extras/ListContactDetails.aspx">Contact Us Details</a></li> 
	            </ul>						
		    </li>
             <li  class="nav">
             ...
             <!--Store------------------>          
			<li  class="nav">
				<a href="javascript:;">Store Management</a>
				<ul class="subNav">
                <li><a href="/Order/ManageShipping.aspx">Assign Shipping Charges</a></li> 
					<li><a href="/Common/Sfm/SfmList.aspx?view=shipping_name">Shipping Name</a></li>
                    <li><a href="/Common/Sfm/SfmList.aspx?view=shipping_type">Shipping Type</a></li>                         
				</ul>						
			</li>
             <!----------------------------------------end of store--------------------->
